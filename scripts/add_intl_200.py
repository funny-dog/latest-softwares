...
NEW_APPS = [
    ...
    {"id": "helix", "name": "Helix", "category": "Developer Tools",
    ...
    {"id": "ghostty", "name": "Ghostty", "category": "Developer Tools",
     "repo": "ghostty-org/ghostty",
     "assets": [
         {"platform": "mac-arm64", "pattern": "ghostty-macos-universal.zip"},
     ]},
    {"id": "kitty", "name": "Kitty", "category": "Developer Tools",
     "repo": "kovidgoyal/kitty",
     "assets": [
         {"platform": "mac-arm64", "pattern": "kitty-*-aarch64.txz"},
     ]},
    {"id": "zellij", "name": "Zellij", "category": "Developer Tools",
     "repo": "zellij-org/zellij",
     "assets": [
         {"platform": "win-x64", "pattern": "zellij-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "zellij-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "zellij-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "starship", "name": "Starship", "category": "Developer Tools",
     "repo": "starship/starship",
     "assets": [
         {"platform": "win-x64", "pattern": "starship-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "starship-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "starship-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "nushell", "name": "Nushell", "category": "Developer Tools",
     "repo": "nushell/nushell",
     "assets": [
         {"platform": "win-x64", "pattern": "nu-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "nu-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "nu-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "fish", "name": "Fish Shell", "category": "Developer Tools",
     "repo": "fish-shell/fish-shell",
     "assets": [
         {"platform": "mac-arm64", "pattern": "fish-*-universal.pkg"},
     ]},
    {"id": "lazydocker", "name": "Lazydocker", "category": "Developer Tools",
    ...
    {"id": "bottom", "name": "bottom", "category": "Developer Tools",
     "repo": "ClementTsang/bottom",
     "assets": [
         {"platform": "win-x64", "pattern": "bottom_*_x86_64-pc-windows-msvc.tar.gz"},
         {"platform": "mac-arm64", "pattern": "bottom_*_aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "bottom_*_x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "btop", "name": "btop++", "category": "Developer Tools",
    ...
    {"id": "dust", "name": "dust", "category": "Developer Tools",
     "repo": "bootandy/dust",
     "assets": [
         {"platform": "win-x64", "pattern": "dust-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "dust-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "dust-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "duf", "name": "duf", "category": "Developer Tools",
     "repo": "muesli/duf",
     "assets": [
    ...
    {"id": "procs", "name": "procs", "category": "Developer Tools",
     "repo": "dalance/procs",
     "assets": [
         {"platform": "win-x64", "pattern": "procs-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "procs-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "procs-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "sd", "name": "sd", "category": "Developer Tools",
     "repo": "chmln/sd",
     "assets": [
         {"platform": "win-x64", "pattern": "sd-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "sd-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "sd-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "delta", "name": "git-delta", "category": "Developer Tools",
     ...
     "assets": [
         ...
         {"platform": "linux-x64", "pattern": "delta-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "difftastic", "name": "Difftastic", "category": "Developer Tools",
     ...
     "assets": [
         ...
         {"platform": "linux-x64", "pattern": "difft-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "gitui", "name": "GitUI", "category": "Developer Tools",
    ...
    {"id": "hyperfine", "name": "hyperfine", "category": "Developer Tools",
     "repo": "sharkdp/hyperfine",
     "assets": [
         {"platform": "win-x64", "pattern": "hyperfine-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "hyperfine-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "hyperfine-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "hexyl", "name": "hexyl", "category": "Developer Tools",
     "repo": "sharkdp/hexyl",
     "assets": [
         {"platform": "win-x64", "pattern": "hexyl-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "hexyl-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "hexyl-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "xh", "name": "xh", "category": "Developer Tools",
     "repo": "ducaale/xh",
     "assets": [
         {"platform": "win-x64", "pattern": "xh-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "xh-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "xh-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "ruff", "name": "Ruff", "category": "Developer Tools",
     "repo": "astral-sh/ruff",
     "assets": [
         {"platform": "win-x64", "pattern": "ruff-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "ruff-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "ruff-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "uv", "name": "uv", "category": "Developer Tools",
     "repo": "astral-sh/uv",
     "assets": [
         {"platform": "win-x64", "pattern": "uv-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "uv-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "uv-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "biome", "name": "Biome", "category": "Developer Tools",
     "repo": "biomejs/biome",
     "assets": [
    ...
    {"id": "nextest", "name": "cargo-nextest", "category": "Developer Tools",
     "repo": "nextest-rs/nextest",
     "assets": [
         {"platform": "win-x64", "pattern": "cargo-nextest-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "cargo-nextest-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "cargo-nextest-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "cargo-binstall", "name": "cargo-binstall", "category": "Developer Tools",
     "repo": "cargo-bins/cargo-binstall",
     "assets": [
         {"platform": "win-x64", "pattern": "cargo-binstall-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "cargo-binstall-aarch64-apple-darwin.zip"},
         {"platform": "linux-x64", "pattern": "cargo-binstall-x86_64-unknown-linux-gnu.tgz"},
     ]},
    {"id": "trunk", "name": "Trunk", "category": "Developer Tools",
     "repo": "trunk-rs/trunk",
     "assets": [
         {"platform": "win-x64", "pattern": "trunk-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "trunk-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "trunk-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "lefthook", "name": "Lefthook", "category": "Developer Tools",
    ...
    {"id": "typos", "name": "typos", "category": "Developer Tools",
     "repo": "crate-ci/typos",
     "assets": [
         {"platform": "win-x64", "pattern": "typos-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "typos-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "typos-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "taplo", "name": "Taplo", "category": "Developer Tools",
     "repo": "tamasfe/taplo",
     "assets": [
    ...
    {"id": "tokei", "name": "tokei", "category": "Developer Tools",
     ...
     "assets": [
         ...
         {"platform": "linux-x64", "pattern": "tokei-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "grex", "name": "grex", "category": "Developer Tools",
     "repo": "pemistahl/grex",
     "assets": [
         {"platform": "win-x64", "pattern": "grex-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "grex-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "grex-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "just", "name": "just", "category": "Developer Tools",
     "repo": "casey/just",
     "assets": [
         {"platform": "win-x64", "pattern": "just-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "just-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "just-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "watchexec", "name": "watchexec", "category": "Developer Tools",
     "repo": "watchexec/watchexec",
     "assets": [
         {"platform": "win-x64", "pattern": "watchexec-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "watchexec-*-aarch64-apple-darwin.tar.xz"},
         {"platform": "linux-x64", "pattern": "watchexec-*-x86_64-unknown-linux-musl.tar.xz"},
     ]},
    {"id": "bandwhich", "name": "bandwhich", "category": "Developer Tools",
     "repo": "imsnif/bandwhich",
     "assets": [
         {"platform": "win-x64", "pattern": "bandwhich-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "bandwhich-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "bandwhich-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "dog", "name": "dog", "category": "Developer Tools",
     "repo": "ogham/dog",
     "assets": [
         {"platform": "win-x64", "pattern": "dog-v*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "dog-v*-x86_64-apple-darwin.zip"},
         {"platform": "linux-x64", "pattern": "dog-v*-x86_64-unknown-linux-musl.zip"},
     ]},
    {"id": "vivid", "name": "vivid", "category": "Developer Tools",
     "repo": "sharkdp/vivid",
     "assets": [
         {"platform": "win-x64", "pattern": "vivid-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "vivid-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "vivid-*-x86_64-unknown-linux-gnu.tar.gz"},
     ]},
    {"id": "htmlq", "name": "htmlq", "category": "Developer Tools",
     "repo": "mgdm/htmlq",
     "assets": [
         {"platform": "win-x64", "pattern": "htmlq-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "htmlq-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "htmlq-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "choose", "name": "choose", "category": "Developer Tools",
     "repo": "theryangeary/choose",
     "assets": [
         {"platform": "win-x64", "pattern": "choose-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "choose-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "choose-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "git-cliff", "name": "git-cliff", "category": "Developer Tools",
     "repo": "orhun/git-cliff",
     "assets": [
         {"platform": "win-x64", "pattern": "git-cliff-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "git-cliff-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "git-cliff-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "cocogitto", "name": "Cocogitto", "category": "Developer Tools",
     "repo": "cocogitto/cocogitto",
     "assets": [
         {"platform": "win-x64", "pattern": "cocogitto-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "cocogitto-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "cocogitto-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "mask", "name": "mask", "category": "Developer Tools",
     ...
     "assets": [
         ...
         {"platform": "linux-x64", "pattern": "mask-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "miniserve", "name": "miniserve", "category": "Developer Tools",
     "repo": "svenstaro/miniserve",
     "assets": [
         {"platform": "win-x64", "pattern": "miniserve-*-x86_64-pc-windows-msvc.zip"},
         {"platform": "mac-arm64", "pattern": "miniserve-*-aarch64-apple-darwin.tar.gz"},
         {"platform": "linux-x64", "pattern": "miniserve-*-x86_64-unknown-linux-musl.tar.gz"},
     ]},
    {"id": "httpie", "name": "HTTPie", "category": "Developer Tools",
     "repo": "httpie/cli",
     "assets": [
    ...
    {"id": "hyper", "name": "Hyper", "category": "System Utilities",
     "repo": "vercel/hyper",
     "assets": [
    ...
    # Utilities (20)
    # ═══════════════════════════════════════════════════════════════
    {"id": "syncthing", "name": "Syncthing", "category": "Utilities",
    ...
    {"id": "kopia", "name": "Kopia", "category": "Utilities",
     "repo": "kopia/kopia",
     "assets": [
    ...
    {"id": "restic", "name": "restic", "category": "Utilities",
     "repo": "restic/restic",
     "assets": [
    ...
    {"id": "duplicati", "name": "Duplicati", "category": "Utilities",
     "repo": "duplicati/duplicati",
     "assets": [
         {"platform": "win-x64", "pattern": "duplicati-*-x64.msi"},
     ]},
    {"id": "rclone", "name": "rclone", "category": "Utilities",
     "repo": "rclone/rclone",
     "assets": [
    ...
    {"id": "fx", "name": "fx", "category": "Utilities",
     "repo": "antonmedv/fx",
     "assets": [
    ...
    {"id": "glow", "name": "glow", "category": "Utilities",
    ...
    {"id": "slides", "name": "slides", "category": "Utilities",
    ...
    {"id": "soft-serve", "name": "Soft Serve", "category": "Utilities",
    ...
    {"id": "gum", "name": "gum", "category": "Utilities",
    ...
    {"id": "vhs", "name": "vhs", "category": "Utilities",
    ...
    {"id": "charm", "name": "charm", "category": "Utilities",
    ...
    {"id": "skate", "name": "skate", "category": "Utilities",
    ...
    # Network & Proxy (15)
    # ═══════════════════════════════════════════════════════════════
    {"id": "clash-verge-rev", "name": "Clash Verge Rev", "category": "Network & Proxy",
    ...
    {"id": "headscale", "name": "Headscale", "category": "Network & Proxy",
    ...
    {"id": "vita3k", "name": "Vita3K", "category": "Gaming",
     "repo": "Vita3K/Vita3K",
     "assets": [
    ...
    {"id": "ryujinx", "name": "Ryujinx", "category": "Gaming",
    ...
    {"id": "xemu", "name": "xemu", "category": "Gaming",
    ...
    {"id": "dosbox-staging", "name": "DOSBox Staging", "category": "Gaming",
     ...
     "assets": [
         ...
         {"platform": "linux-x64", "pattern": "dosbox-staging-*-linux-x86_64.tar.xz"},
     ]},
    {"id": "libretro", "name": "RetroArch", "category": "Gaming",
     "repo": "libretro/RetroArch",
     "assets": [
         {"platform": "win-x64", "pattern": "RetroArch-*-x64-setup.exe"},
         {"platform": "mac-arm64", "pattern": "RetroArch-*-arm64.dmg"},
     ]},
    {"id": "mudlet", "name": "Mudlet", "category": "Gaming",
     "repo": "Mudlet/Mudlet",
     "assets": [
    ...
    # Media & Creative (20)
    # ═══════════════════════════════════════════════════════════════
    {"id": "kdenlive", "name": "Kdenlive", "category": "Media Players",
     "repo": "KDE/kdenlive",
     "assets": [
         {"platform": "win-x64", "pattern": "kdenlive-*-x86_64.exe"},
     ]},
    {"id": "olive", "name": "Olive Video Editor", "category": "Media Players",
    ...
    {"id": "strawberry", "name": "Strawberry Music Player", "category": "Media Players",
     "repo": "strawberrymusicplayer/strawberry",
     "assets": [
         {"platform": "win-x64", "pattern": "strawberry-*-msvc-x64.exe"},
     ]},
    {"id": "musicbrainz", "name": "MusicBrainz Picard", "category": "Media Players",
     "repo": "metabrainz/picard",
     "assets": [
         {"platform": "win-x64", "pattern": "musicbrainz-picard-*-win-x86_64.exe"},
         {"platform": "mac-arm64", "pattern": "MusicBrainz-Picard-*-macOS-arm64.dmg"},
     ]},
    {"id": "mkvtoolnix", "name": "MKVToolNix", "category": "Media Players",
     "repo": "mbunkus/mkvtoolnix",
     "assets": [
         {"platform": "win-x64", "pattern": "mkvtoolnix-64-bit-*-setup.exe"},
     ]},
    {"id": "mediainfo", "name": "MediaInfo", "category": "Media Players",
     "repo": "MediaArea/MediaInfo",
     "assets": [
         {"platform": "win-x64", "pattern": "MediaInfo_GUI_*_Windows_x64.exe"},
     ]},
    {"id": "gimp", "name": "GIMP", "category": "Media Players",
     "repo": "GNOME/gimp",
     "assets": [
         {"platform": "win-x64", "pattern": "gimp-*-setup.exe"},
     ]},
    {"id": "krita", "name": "Krita", "category": "Media Players",
     "repo": "KDE/krita",
     "assets": [
    ...
    {"id": "inkscape", "name": "Inkscape", "category": "Media Players",
     "repo": "inkscape/inkscape",
     "assets": [
         {"platform": "win-x64", "pattern": "inkscape-*-x64.msi"},
     ]},
    {"id": "blender", "name": "Blender", "category": "Media Players",
    ...
    {"id": "freecad", "name": "FreeCAD", "category": "Media Players",
    ...
    # Productivity (15)
    # ═══════════════════════════════════════════════════════════════
    {"id": "appflowy", "name": "AppFlowy", "category": "Productivity",
    ...
    {"id": "anytype", "name": "Anytype", "category": "Productivity",
    ...
    {"id": "trilium", "name": "Trilium Notes", "category": "Productivity",
    ...
    {"id": "zettlr", "name": "Zettlr", "category": "Productivity",
     "repo": "Zettlr/Zettlr",
     "assets": [
    ...
    {"id": "drawio", "name": "draw.io", "category": "Productivity",
    ...
    {"id": "excalidraw", "name": "Excalidraw", "category": "Productivity",
     "repo": "excalidraw/excalidraw",
     "assets": [
         {"platform": "win-x64", "pattern": "Excalidraw-*-x64.exe"},
     ]},
    {"id": "beekeeper", "name": "Beekeeper Studio", "category": "Productivity",
    ...
    {"id": "sumatrapdf", "name": "Sumatra PDF", "category": "Productivity",
    ...
    {"id": "sioyek", "name": "Sioyek", "category": "Productivity",
     "repo": "ahrm/sioyek",
     "assets": [
         {"platform": "win-x64", "pattern": "sioyek-release-windows.zip"},
         {"platform": "mac-arm64", "pattern": "sioyek-apple-silicon.dmg"},
         {"platform": "linux-x64", "pattern": "sioyek-release-linux-portable.tar.gz"},
     ]},
    {"id": "pomatez", "name": "Pomatez", "category": "Productivity",
    ...
    # Messaging (5)
    # ═══════════════════════════════════════════════════════════════
    {"id": "element", "name": "Element", "category": "Messaging",
    ...
    {"id": "cinny", "name": "Cinny", "category": "Messaging",
    ...
    {"id": "hexchat", "name": "HexChat", "category": "Messaging",
     "repo": "hexchat/hexchat",
     "assets": [
         {"platform": "win-x64", "pattern": "HexChat-*-x64.exe"},
     ]},
    {"id": "protonmail-bridge", "name": "Proton Mail Bridge", "category": "Messaging",
    ...
    {"id": "fluffy-chat", "name": "FluffyChat", "category": "Messaging",
    ...
    # AI Tools (10)
    # ═══════════════════════════════════════════════════════════════
    {"id": "localai", "name": "LocalAI", "category": "AI Tools",
     "repo": "mudler/LocalAI",
     "assets": [
    ...
    {"id": "comfyui", "name": "ComfyUI", "category": "AI Tools",
     "repo": "comfyanonymous/ComfyUI",
     "assets": [
         {"platform": "win-x64", "pattern": "ComfyUI_windows_portable_nvidia.7z"},
     ]},
    {"id": "invokeai", "name": "InvokeAI", "category": "AI Tools",
    ...
    {"id": "whisper", "name": "Whisper", "category": "AI Tools",
     "repo": "openai/whisper",
     "assets": [
         {"platform": "linux-x64", "pattern": "whisper-*-linux-amd64"},
     ]},
    {"id": "llama-cpp", "name": "llama.cpp", "category": "AI Tools",
    ...
    {"id": "open-webui", "name": "Open WebUI", "category": "AI Tools",
    ...
    {"id": "koboldcpp", "name": "KoboldCpp", "category": "AI Tools",
    ...
    # Security & Privacy (5)
    # ═══════════════════════════════════════════════════════════════
    {"id": "age", "name": "age", "category": "Security & Privacy",
    ...
    {"id": "sops", "name": "sops", "category": "Security & Privacy",
     "repo": "getsops/sops",
     "assets": [
    ...
    # Cloud & DevOps (10)
    # ═══════════════════════════════════════════════════════════════
    {"id": "docker-compose", "name": "Docker Compose", "category": "Cloud & DevOps",
     "repo": "docker/compose",
     "assets": [
    ...
    {"id": "k9s", "name": "k9s", "category": "Cloud & DevOps",
     "repo": "derailed/k9s",
     "assets": [
    ...
    {"id": "helm", "name": "Helm", "category": "Cloud & DevOps",
     "repo": "helm/helm",
     "assets": [
    ...
    {"id": "vault", "name": "Vault", "category": "Cloud & DevOps",
    ...
    {"id": "consul", "name": "Consul", "category": "Cloud & DevOps",
    ...
    {"id": "nomad", "name": "Nomad", "category": "Cloud & DevOps",
    ...
    {"id": "boundary", "name": "Boundary", "category": "Cloud & DevOps",
    ...
    {"id": "k3s", "name": "k3s", "category": "Cloud & DevOps",
     "repo": "k3s-io/k3s",
     "assets": [
         {"platform": "linux-x64", "pattern": "k3s"},
     ]},
    {"id": "k6", "name": "k6", "category": "Cloud & DevOps",
     "repo": "grafana/k6",
     "assets": [
