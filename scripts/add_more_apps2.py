...
more_apps = [
    ...
    (
        ...
        "Windows Terminal",
        "microsoft/terminal",
        "Microsoft.WindowsTerminal_*.msixbundle",
        "Developer Tools",
    ),
    ...
    (
        ...
        "TranslucentTB-appinstaller.zip",
        "System Utilities",
    ),
    (
        "lively",
    ...
    (
        ...
        "Mattermost",
        "mattermost/desktop",
        "mattermost-desktop-*-win-x64.exe",
        "Messaging",
    ),
    (
        "teamspeak",
        "TeamSpeak",
        "TeamSpeak-Systems/TeamSpeak-Client",
        "TeamSpeak3-Client-win64-*.exe",
        "Messaging",
    ),  # might not be there
    # Browsers
    ...
    (
        ...
        "floorp-*-win64-setup.exe",
        "Browsers",
    ),
    (
        "librewolf",
        "LibreWolf",
        "LibreWolf-Community/librewolf-win",
        "librewolf-*-windows-x86_64-setup.exe",
        "Browsers",
    ),
    (
        "chromium",
    ...
    (
        "ryujinx",
        "Ryujinx",
        "Ryujinx/release-channel-master",
        "test-ava-ryujinx-*-win_x64.zip",
        "Gaming",
    ),
